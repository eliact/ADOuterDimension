...
export default {
  ...
  methods: {
    update() {
      ...
      const isOuterUnlocked = progress.isOuter;
      const outer = this.outer;
      outer.isUnlocked = isOuterUnlocked;
...
<template>
  <div class="c-stats-tab">
    ...
    <div
      v-if="outer.isUnlocked"
      class="c-stats-tab-subheader c-stats-tab-general"
    >
      <div class="c-stats-tab-outer c-stats-tab-title">
        Outer Game
      </div>
      <div>You have {{ quantifyInt("Outer", outer.count) }}.</div>
      <div>You have {{ quantifyInt("Outer Fragment", outer.fragment) }}.</div>
    </div>
  </div>
</template>
