...
import OuterGameNewModal from "@/components/modals/OuterGameNewModal";
...
Modal.outer = new Modal(EnterOuterCelestialsModal, 1);
...
Modal.OuterGameNew = new Modal(OuterGameNewModal, 1);
...
function getSaveInfo(save) {
  ...
  resources.outers = save.outers ?? 0;
